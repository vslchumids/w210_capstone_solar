...
```{r}
#Office Model
data_office =subset(data_small, PBA_NAME == 'Warehouse No Fridge')
length(data_office$PUBID)

office_fit = lm(ELCNS ~ SQFT + YRCON + NWKER + GLSSPC + WKHRS + OPEN24 + NELVTR + NESLTR + OPNWE, data = data_office)
