...
def get_monthly_num_workhours_pct(year=None, 
    ...
    Args:
        ...
        operating_hours ([floats]): Number of operatings for each day of week, starting with Monday;
    ...
    if year == None or year < 2000:
        ...
        for i in range(12):
            ...
            for j in range(temp_num_days):
                ...
                # update count of each days of week in the range
                ...
                #TO-DO: daily_df.loc[daily_hrs_index, 'num_day_hours'] = operating_hours[day_of_week_index] *
                #TO-DO: daily_df.loc[daily_hrs_index, 'num_night_hours'] = operating_hours[day_of_week_index] *
